...
public class XMLParserTest extends AndroidTestCase {
	...
	@Test
	public void testInitializateReader() throws ParserConfigurationException, SAXException {
		XMLParser testParser = new XMLParser();
		XMLReader xmlReader = testParser.readerStarter();
	...
	@Test
	public void testProjectParsingException() {
